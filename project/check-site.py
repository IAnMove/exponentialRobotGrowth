...
for directory, language in [(public, 'en'), (public / 'es', 'es')]:
    for route in ['index.html', 'terafab/index.html', 'growth/index.html', 'home/index.html', 'dyson/index.html', 'starlink/index.html', 'spacex/index.html', 'kardashev/index.html', 'llms/index.html', 'mente/index.html', 'modelos/index.html', 'museo/index.html']:
        content = (directory / route).read_text(encoding='utf-8')
        assert f'<html lang="{language}">' in content
        assert '{{' not in content
    for topic in ['robots', 'terafab', 'home', 'dyson', 'starlink', 'spacex', 'kardashev', 'llms', 'mente', 'modelos', 'museo', 'journeys', 'immersive']:
