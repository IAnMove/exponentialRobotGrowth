...
for language in ['en', 'es']:
    ...
    for folder in ['hub', 'fx', 'terafab', 'growth', 'home', 'dyson', 'starlink', 'spacex', 'kardashev', 'llms', 'mente', 'modelos', 'museo', 'immersive', 'live']:
        ...
        for source in (ROOT / 'site-src' / folder).iterdir():
            ...
            if folder in ['fx', 'terafab', 'home', 'dyson', 'starlink', 'spacex', 'kardashev', 'llms', 'mente', 'modelos', 'museo', 'immersive'] and language == 'es' and source.suffix == '.js':
                content = content.replace("'../vendor/", "'../../vendor/")
            if source.suffix == '.html':
