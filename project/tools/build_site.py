...
for language in ['en', 'es']:
    ...
    for folder in ['hub', 'terafab', 'growth', 'home', 'dyson', 'starlink', 'spacex', 'kardashev', 'llms', 'mente', 'modelos', 'museo', 'journeys', 'immersive', 'live']:
        ...
        for source in (ROOT / 'site-src' / folder).iterdir():
            ...
            if folder in ['terafab', 'home', 'dyson', 'starlink', 'spacex', 'kardashev', 'llms', 'mente', 'modelos', 'museo', 'journeys', 'immersive'] and language == 'es' and source.suffix == '.js':
                content = content.replace("'../vendor/", "'../../vendor/")
            if source.suffix == '.html':
                ...
                if language == 'en':
                    ...
                    content = content.replace('Explora cómo funcionan los sistemas: robots, chips, una esfera de Dyson, el hogar, Starlink, SpaceX, Kardashev, modelos de lenguaje, un cerebro y el precio del caché. Camina el museo o abre cada página.', 'Explore how systems work: robots, chips, a Dyson sphere, the home, Starlink, SpaceX, Kardashev, language models, a brain and the price of cache. Walk the museum or open each page.')
