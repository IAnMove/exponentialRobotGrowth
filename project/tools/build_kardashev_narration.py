"""Generate only the five bilingual Kardashev clips, reusing completed audio."""
...
scripts = json.loads((ROOT/'narration/kardashev.json').read_text(encoding='utf-8'))
catalog_file=ROOT/'site-src/kardashev/voices.js'
cached={}
...
def generate(job):
    ...
    filename = f'kardashev-{lang}-{entry["id"]}-{digest}.mp3'
...
if __name__=='__main__':
    ...
    (ROOT/'site-src/kardashev/voices.js').write_text(code,encoding='utf-8')
    print('Kardashev: 10 recorded bilingual clips ready.')
