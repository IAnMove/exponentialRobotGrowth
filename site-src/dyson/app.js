...
$('app').innerHTML=`<nav class="nav"><a href="../index.html">← Atlas</a><a href="../starlink/index.html">Starlink</a><a href="../spacex/index.html">SpaceX</a><a href="../home/index.html">${t('Hogar','Home')}</a><span><a href="${es?'../../dyson/index.html':'./index.html'}" lang="en">EN</a> / <a href="${es?'./index.html':'../es/dyson/index.html'}" lang="es">ES</a></span></nav>
