...
function update(){
  ...
  $('r-gain').textContent=fmt((state.fleet+state.exported)/(reference.fleet+reference.exported),2)+'×';$('r-chart-end').textContent='Cycle '+Math.floor(state.time)+' / 120';
