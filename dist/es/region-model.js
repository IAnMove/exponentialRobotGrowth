...
export const TYPES=[
  {name:'Extracción',unit:'mineral / ciclo',color:0xdab68c,rate:12,description:'Las minas abastecen a las refinerías. Más plantas necesitan más mineral.'},
  {name:'Refinado',unit:'material / ciclo',color:0xedb07b,rate:8,description:'El material refinado se reparte entre componentes y construcción. Invertir también consume recursos.'},
  {name:'Componentes robóticos',unit:'kits / ciclo',color:0x8ccebb,rate:4,description:'Agrupa estructuras, actuadores, baterías y electrónica. Dos lotes de material forman un kit.'},
  {name:'Fábricas de robots',unit:'robots / ciclo',color:0xb0cbea,rate:4,description:'Un kit se transforma en un robot. Los nuevos robots pueden producir o construir más instalaciones.'},
  {name:'Generación eléctrica',unit:'energía / ciclo',color:0xe8d68e,rate:36,description:'La potencia disponible limita a toda la región. La red eléctrica también tiene que crecer.'},
